    ...
    return (
        <div className=" sm:mx-4 p-6 rounded-[8px] white-glassmorphism mb-8 flex flex-col">
            ...
            <div className="aspect-video relative mb-4 h-[200px]">
                <img className="w-full sm:h-full object-cover" src={gif} alt="gif" />
                <span className="block absolute bottom-0 left-[50%] w-fit translate-x-[-50%] translate-y-[50%] whitespace-nowrap px-4 py-2 bg-black rounded-[6px] text-cyan-400">
                    {timeSlamp}
                </span>
            </div>
        </div>
